package br.com.conductor.selecao.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.conductor.selecao.repository",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "br.com.conductor.selecao.model" });
